...
THREE.TransformControlsGizmo = function () {
    ...
    matLineBlue.color.set(0xaaaaaa);
    ...
    var gizmoTranslate = {
        ...
        XY: [
            [
                new THREE.Mesh(
                    new THREE.PlaneGeometry(0.295, 0.295),
    ...
    var pickerTranslate = {
        ...
        XY: [
            [
                new THREE.Mesh(new THREE.PlaneGeometry(0.4, 0.4), matInvisible),
                [0.2, 0.2, 0],
            ],
        ],
        YZ: [
    ...
    var helperTranslate = {
        START: [
            [
                new THREE.Mesh(
                    new THREE.OctahedronGeometry(0.01, 2),
                    matHelper
                ),
                null,
                null,
    ...
    var gizmoRotate = {
        X: [
            ...
            [
                new THREE.Mesh(new THREE.OctahedronGeometry(0.04, 0), matRed),
                [0, 0, 0.99],
                null,
                [1, 3, 1],
            ],
        ...
        Y: [
            ...
            [
                new THREE.Mesh(new THREE.OctahedronGeometry(0.04, 0), matGreen),
                [0, 0, 0.99],
                null,
                [3, 1, 1],
            ],
        ...
        Z: [
            ...
            [
                new THREE.Mesh(new THREE.OctahedronGeometry(0.04, 0), matBlue),
                [0.99, 0, 0],
                null,
                [1, 3, 1],
            ],
        ...
        E: [
            ...
            [
                new THREE.Mesh(
                    new THREE.CylinderGeometry(0.03, 0, 0.15, 4, 1, false),
                    matLineYellowTransparent
                ),
                [1.17, 0, 0],
                [0, 0, -Math.PI / 2],
    ...
    var pickerRotate = {
        X: [
            [
                new THREE.Mesh(
                    new THREE.TorusGeometry(1, 0.1, 4, 24),
                    matInvisible
                ),
                [0, 0, 0],
        ...
        E: [
            [
                new THREE.Mesh(
                    new THREE.TorusGeometry(1.25, 0.1, 2, 24),
                    matInvisible
                ),
            ],
        ],
    ...
    var pickerScale = {
        X: [
            [
                new THREE.Mesh(
                    new THREE.CylinderGeometry(0.2, 0, 0.8, 4, 1, false),
                    matInvisible
                ),
                [0.5, 0, 0],
                [0, 0, -Math.PI / 2],
